...
[![GoDoc](https://godoc.org/github.com/pauradev/i18n?status.svg)](https://godoc.org/github.com/pauradev/i18n)
...
### Use built-in interface for translation management with [QOR Admin](http://github.com/pauradev/admin)

I18n has a built-in web interface for translations which is integrated with [QOR Admin](http://github.com/pauradev/admin).

```go
Admin.AddResource(I18n)
```

Then a page like this will be added to [QOR Admin](http://github.com/pauradev/admin) interface
...
You could manage translations' data with [QOR Admin](http://github.com/pauradev/admin) interface (UI) after registering it into [QOR Admin](http://github.com/pauradev/admin), however we warn you that it is usually quite hard (and error prone!) to *translate a translation* without knowing its context...Fortunately, the *Inline Edit* feature of [QOR Admin](http://github.com/pauradev/admin) was developed to resolve this problem!
