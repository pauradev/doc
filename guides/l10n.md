...
L10n gives your [GORM](https://github.com/pauradev/gorm) models the ability to localize for different Locales. It can be a catalyst for the adaptation of a product, application, or document content to meet the language, cultural, and other requirements of a specific target market.

[![GoDoc](https://godoc.org/github.com/pauradev/l10n?status.svg)](https://godoc.org/github.com/pauradev/l10n)

## Usage

L10n utilizes [GORM](https://github.com/pauradev/gorm) callbacks to handle localization, so you will need to register callbacks first:

```go
import (
  "github.com/pauradev/gorm"
  "github.com/pauradev/l10n"
)
...
`l10n.Locale` will add a `language_code` column as a composite primary key with existing primary keys, using [GORM](https://github.com/pauradev/gorm)'s AutoMigrate to create the field.
...
Although L10n could be used alone, it integrates nicely with [QOR](https://github.com/pauradev/qor).

[L10n Demo with QOR](http://demo.getqor.com/admin/products)

By default, [QOR](https://github.com/pauradev/qor) will only allow you to manage the global language. If you have configured [Authentication](http://doc.getqor.com/admin/authentication.html), [QOR Admin](http://github.com/pauradev/admin) will try to obtain the allowed Locales from the current user.
