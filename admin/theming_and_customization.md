...
[A default implemention](https://github.com/pauradev/assetfs/blob/master/filesystem.go) of `AssetFS` is looking up templates from the filesystem with pre-registered view paths.

it includes:

* {current_path}/app/views/qor
* {current_path}/vendor/github.com/pauradev/admin/views
* $GOPATH/src/github.com/pauradev/admin/views

Checkout [AssetFS](http://github.com/pauradev/assetfs) for more details
...
QOR Admin is using go templates to render admin interface, default templates could be found from https://github.com/pauradev/admin/tree/master/views
